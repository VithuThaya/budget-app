  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-xl flex-col items-center justify-center px-6 text-center">
      <div className="card w-full p-8">
        ...
        <h1 className="text-xl font-semibold text-silver">Connect your free database</h1>
        ...
        <pre className="mt-4 overflow-x-auto rounded-xl border border-white/10 bg-ink-900/60 p-4 text-left text-xs text-zinc-300 backdrop-blur-md">
